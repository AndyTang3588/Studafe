...
public class JoinZoneWithMute : PlayerJoinZone
{
    ...
    [SerializeField] private MuteOthersOutArea _muteManager; // 拖入 MuteOthersOutArea 组件
    ...
    {
        base.OnPlayersChanged();
        
        VRCPlayerApi[] playersInZone = GetPlayersInZone(); // 获取当前区域内的玩家
        _muteManager.UpdateMutedPlayersList(playersInZone); // 让 MuteOthersOutArea 更新静音状态
    }
